...
public class MyPancreasCollectionService extends Service {
    private final static String TAG = MyPancreasCollectionService.class.getSimpleName();
    ...
    public void onCreate() {
        super.onCreate();
        //readData = new ReadDataShare(this); todo: read data
        service = this;
